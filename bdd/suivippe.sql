...
-- Généré le :  Jeu 04 Avril 2019 à 10:30
...
-- Procédures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteStage` (IN `idstagetodel` INT)  NO SQL
BEGIN
...
--
ALTER TABLE `situation`
  MODIFY `reference` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=977;
--
