...
--
-- Client :  localhost
-- Généré le :  Mar 14 Novembre 2017 à 14:56
...
INSERT INTO `situation` (`reference`, `login`, `libelle`, `descriptif`, `datedebut`, `datefin`, `codeCadre`, `codeLocalisation`, `codeLangage`, `codeFramework`) VALUES
(1, 'test.v2', 'test', 'test', NULL, NULL, NULL, NULL, 4, 6),
(2, 'test.v2', 'SuiviPPE', 'Site de gestion du PPE', NULL, NULL, NULL, NULL, 3, 4),
(3, 'test.v2', 'Voiture', 'TP Voiture C#', NULL, NULL, NULL, NULL, 2, 2);
...
INSERT INTO `utilisateur` (`login`, `password`, `type`, `classe`, `nom`, `prenom`, `mail`, `salt`, `roles`, `numParcours`) VALUES
('test.v2', '123ABC', 1, 'B2', 'DUPONT', 'Marc', 'jlb.epsi@gmail.com', '', 'USER', 2);
